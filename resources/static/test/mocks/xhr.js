...
BrowserID.Mocks.xhr = (function() {
  ...
  var xhr = {
    ...
    responses: {
      ...
      "get /wsapi/address_info?email=unregistered%40testuser.com&issuer=default throttle": { type: "secondary", known: false },
      "get /wsapi/address_info?email=unregistered%40testuser.com&issuer=default valid": { type: "secondary", known: false },
      "get /wsapi/address_info?email=unregistered%40testuser.com&issuer=default unknown_secondary": { type: "secondary", known: false },
      "get /wsapi/address_info?email=unregistered%40testuser.com&issuer=default primary": { type: "primary", auth: "https://auth_url", prov: "https://prov_url" },

      "get /wsapi/address_info?email=registered%40testuser.com&issuer=default valid": { type: "secondary", known: true },
      "get /wsapi/address_info?email=registered%40testuser.com&issuer=default known_secondary": { type: "secondary", known: true },
      "get /wsapi/address_info?email=registered%40testuser.com&issuer=default throttle": { type: "secondary", known: true },
      "get /wsapi/address_info?email=registered%40testuser.com&issuer=default primary": { type: "primary", auth: "https://auth_url", prov: "https://prov_url" },
      "get /wsapi/address_info?email=registered%40testuser.com&issuer=default mustAuth": { type: "secondary", known: true },

      "get /wsapi/address_info?email=testuser%40testuser.com&issuer=default valid": { type: "secondary", known: true },
      "get /wsapi/address_info?email=testuser%40testuser.com&issuer=default known_secondary": { type: "secondary", known: true },
      "get /wsapi/address_info?email=testuser%40testuser.com&issuer=default unknown_secondary": { type: "secondary", known: false },
      "get /wsapi/address_info?email=testuser%40testuser.com&issuer=default primary": { type: "primary", auth: "https://auth_url", prov: "https://prov_url" },
